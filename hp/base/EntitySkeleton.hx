...
interface EntitySkeleton {
    ...
    public function update(dt:Float):Void; // called by Entities.update(), used in the main update loop
    public function remove():Void; // called by Entities.remove(), used in the main remove everything function
}
