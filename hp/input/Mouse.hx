...
class Mouse { // or/and Touch? TODO: is this the same for touch input?
	...
	public static var leftJustClicked(get, null):Bool;
	...
	public static function leftJustClicked():Bool return Key.isPressed(Key.MOUSE_LEFT); // isPressed is confusing :(
	public static function leftJustReleased():Bool return Key.isReleased(Key.MOUSE_LEFT);
